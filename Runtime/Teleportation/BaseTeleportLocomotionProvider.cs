...
namespace RealityToolkit.Locomotion.Teleportation
{
    ...
    public abstract class BaseTeleportLocomotionProvider : BaseLocomotionProvider, ITeleportLocomotionProvider
    {
        ...
        /// </remarks>
        protected Dictionary<int, IController> OpenTargetRequests { get; } = new();
        ...
        /// </remarks>
        protected Dictionary<int, ITeleportTargetProvider> AvailableTargetProviders { get; } = new();
        ...
        {
            if (!AvailableTargetProviders.ContainsKey(teleportTargetProvider.Controller.InputDevice.deviceId))
            {
                AvailableTargetProviders.Add(teleportTargetProvider.Controller.InputDevice.deviceId, teleportTargetProvider);
            }
        }
        ...
        //{
        //    CleanUpTeleportRequest(context.control.device.deviceId);
